const PATHS = {
    ...
    arrowUp: "M12 19V5m0 0 6 6M12 5 6 11",
...
export function Icon({ name, size = 14 }) {
    return (
        ...
        >
            {name === "eye-pending" ? (
                <>
                    <g transform="translate(-1.2 -2) scale(0.72)">
                        <path d={PATHS.eye} />
                    </g>
                    <path d="M19.5 21.5V13m-2.6 2.6L19.5 13l2.6 2.6" stroke="var(--muxy-diff-add)" strokeWidth="2" />
                </>
            ) : (
