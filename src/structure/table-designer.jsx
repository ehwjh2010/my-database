...
import { createTableFromSql } from "./table-designer-actions.js";
...
export function TableDesignerModal({ session, onClose }) {
    ...
    const create = () => createTableFromSql({ session, sql, onClose, toast });
